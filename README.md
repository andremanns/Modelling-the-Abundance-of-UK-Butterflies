...
## 3. Executive Summary
In this project, UKBMS survey data is used to model the relative abundance of UK butterflies over the last 30 years. For an overview of the methodology, click here. 
<br><br>
